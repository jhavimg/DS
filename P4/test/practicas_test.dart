...
void main() {
  ...
  group ('Gestor de Vehiculos', (){
    ...
    test('GestorVehiculos Test', () async {
    ...
    test('Obtener vehiculo con gestor de tareas', () async {
      final gestor = GestorVehiculos([]);
      ...
      gestor.vehiculos.add(moto);
      gestor.vehiculos.add(coche);

      expect(gestor.vehiculos, lista);

      expect(gestor.vehiculos.length, 2);

    });

    test('Eliminar vehiculo con gestor de tareas', () async {
      final gestor = GestorVehiculos([]);
      ...
      gestor.vehiculos.add(moto);
      gestor.vehiculos.add(coche);
      gestor.vehiculos.add(camion);

      expect(gestor.vehiculos.length, 3);

      gestor.vehiculos.remove(moto);
      lista.removeAt(0);
